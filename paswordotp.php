...
if(!empty($_POST['submit_email'])){$EMAIL1=$_POST['email'];
 ...
 $count=mysqli_num_rows($result);
    ...
    $mail_status=sendOTP1($EMAIL1,$otp1);
    
    if($mail_status==1){$OTPTIME=date("Y-m-d h:i:sa");
      //echo $OTPTIME;
      //$success=1;
      $serial=0;
      $sql1="INSERT INTO `otp_expiry1` (`id`, `OTP_NUMBER`, `is_expiry`, `signtime`) VALUES ('NULL', '$otp1', '0', '$OTPTIME');";
...
.verify-btn{
  ...
  background-color: blue !important;
      ...
      <div class="card text-center">
        ...
        <form  name="frmUser" method="post" id="formm" action="">
        ...
        <input type="text" name="otp" maxlength="6" class="m-1 text-center form-control rounded"  style="width:300px;" placeholder="Enter a 6-digit OTP" required="please Enter 6-digits Code"><br>
        ...
        <p style="color:#31ab00;font-size:20px;"><strong>OTP Verfication Successfully</strong></p>
        <button onclick="myFunction()" class="w3-btn w3-round-xxlarge" style="background-color:green;">SUBMIT</button>
            </div>
        <?php
            }
            else
